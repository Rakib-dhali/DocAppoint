...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav className="bg-white mx-auto max-w-7xl px-6 md:px-12 lg:px-18 xl:px-24 py-4 flex items-center justify-between relative">
                <Link href="/">
                ...
                <button onClick={() => setMenuOpen(!menuOpen)} className="md:hidden flex flex-col gap-1.5 cursor-pointer bg-transparent border-0 p-1 z-50 relative">
