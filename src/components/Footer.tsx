      ...
      <div className="max-w-350 mx-auto px-6 sm:px-12 lg:px-24 py-16 grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 lg:gap-16">
        <div className="md:col-span-4 space-y-5">
          ...
          <p className="text-slate-400 leading-relaxed text-sm max-w-sm">
            Simplifying healthcare access through technology. Connect with the
            right specialists instantly and manage your appointments with ease.
          </p>
        ...
        <div className="md:col-span-4 space-y-4">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-3 pt-1">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-linear-to-r from-blue-600 to-sky-500 hover:from-blue-700 hover:to-sky-600 text-white font-semibold rounded-xl shadow-lg shadow-blue-600/10 transition-all duration-200 active:scale-[0.99] cursor-pointer"
            >
              Subscribe
            </button>
          </form>
