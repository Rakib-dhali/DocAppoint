      ...
      <div className="max-w-350 mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
          ...
          <p className="text-base sm:text-lg text-slate-600 max-w-xl mx-auto lg:mx-0 leading-relaxed">
            Experience the future of healthcare with DocAppoint. Connect with
            top-rated specialists, book slots in seconds, and manage your health
            journey with ease.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
            <button
              onClick={() => redirect("/all-appointment")}
              className="px-8 py-3.5 bg-blue-600 text-white font-semibold rounded-xl shadow-lg shadow-blue-600/20 hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/30 transition-all duration-300 flex items-center justify-center gap-2 group"
            >
              Book Appointment
              <svg
            ...
            <button
              onClick={() => redirect("/all-appointment")}
              className="px-8 py-3.5 bg-white text-blue-600 font-semibold rounded-xl border border-blue-200 shadow-sm hover:bg-blue-50 hover:border-blue-300 transition-all duration-300"
            >
              Explore Doctors
            </button>
          </div>
          <div className="grid grid-cols-3 gap-4 pt-8 max-w-md mx-auto lg:mx-0 border-t border-slate-200/80">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 font-medium uppercase tracking-wider mt-1">
                Specialists
              </p>
            </div>
            ...
            >
              {doctors.map((doctor) => (
                <SwiperSlide key={doctor.id} className="relative w-full h-full">
                  ...
                  <div className="absolute bottom-6 border-2 right-6 left-6 sm:left-auto sm:w-64 bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-xl border-white/40 transform transition-all duration-300 flex items-center gap-3">
